...
/**
 * QuickTemplate class for Hawiki skin
 * @ingroup Skins
 */
class HawikiTemplate extends BaseTemplate {
	...
	public function execute() {
		...
		if ( $this->config->get( 'HawikiUseIconWatch' ) ) {
	...
	protected function renderNavigation( $elements ) {
		...
		foreach ( $elements as $name => $element ) {
			switch ( $element ) {
				case 'NAMESPACES':
					?>
					<div id="p-namespaces" role="navigation" class="hawikiTabs<?php
				...
				case 'VARIANTS':
					?>
					<div id="p-variants" role="navigation" class="hawikiMenu<?php
				...
				case 'VIEWS':
					?>
					<div id="p-views" role="navigation" class="hawikiTabs<?php
				...
				case 'ACTIONS':
					?>
					<div id="p-cactions" role="navigation" class="hawikiMenu<?php
					if ( count( $this->data['action_urls'] ) == 0 ) {
						echo ' emptyPortlet';
					}
					?>" aria-labelledby="p-cactions-label">
						<h3 id="p-cactions-label"><span><?php
							$this->msg( 'hawiki-more-actions' )
						?></span><a href="#"></a></h3>
				...
				case 'SEARCH':
					...
					<div id="p-search" role="search">
						...
						<form action="<?php $this->text( 'wgScript' ) ?>" id="searchform">
							<div<?php echo $this->config->get( 'HawikiUseSimpleSearch' ) ? ' id="simpleSearch"' : '' ?>>
							<?php
